 ...
 *
 * The point of this test is the defect Task 6 exists to fix: `/tags/new` had
 * no `loading.tsx` at all, so a soft navigation into it showed
 * `(app)/loading.tsx`'s generic `<TableSkeleton>` -- a table shape on a page
 * that is a two-field form. It now renders the real `<TagForm pending />`
...
describe("the /tags/new route's loading fallback", () => {
