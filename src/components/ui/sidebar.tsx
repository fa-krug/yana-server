...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      // a wide child (a data table, in practice) refuses to shrink below its
      // own content width and pushes this whole flex row -- sidebar included --
      // wider than the viewport instead of scrolling inside its own
